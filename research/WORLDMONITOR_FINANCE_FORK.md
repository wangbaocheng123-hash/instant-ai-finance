...
- 产品分叉提交：`f7884a12adae6385ea1930c9a20bebb23ba682a5`
- 许可证：`AGPL-3.0-only`
...
- `src/instant-ai/InstantFinanceApp.ts`：顶部“即时 + 全球热点”双滚动栏、12 个财经频道、搜索、来源和详情交互；即时按时间排列，热点按近 72 小时的多来源数、重要度和新鲜度综合排序；只显示自动实时采集状态，不提供手动采集按钮。
