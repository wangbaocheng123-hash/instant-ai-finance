...
第一版只做电脑所有者本人的全球财经情报闭环：覆盖全球/华尔街、中国/亚洲、AI 产业链、紫金矿业、黄金、铜和有色金属、宏观央行、地缘供应链、融资并购和财经知识，从公开来源收集文字信息及轻量图片预览，保留证据，去重和评分，供 Windows 本地阅读，并只推送真正重要的变化。系统不识别“用户”，所有正式数据天然属于本机所有者。
...
- 顶部即时带：最新财经标题持续滚动，点击可看证据详情，不加载直播媒体。
- 新闻卡片：白底黑字；左侧显示来源真图或本机主题封面，右侧显示中英标题、来源、时间与标签，图片按需写入 H 盘可删除缓存。
