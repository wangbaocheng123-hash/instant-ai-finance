...
$requiredFiles = @(
    ...
    'docs/decisions/ADR-0024-beijing-blogger-manifest-ingest-boundary.md',
    'docs/decisions/ADR-0025-singapore-blogger-artifact-transport.md',
    'docs/decisions/ADR-0026-blogger-instant-ai-module-and-beijing-coexistence.md',
    'docs/decisions/ADR-0027-cls-china-source-discovery.md',
    'docs/decisions/ADR-0028-blogger-owner-mobile-workspace-parity.md',
    'docs/decisions/ADR-0029-blogger-readonly-mcp-projection.md',
    'docs/decisions/ADR-0030-chatgpt-direct-cloud-mcp-oauth.md',
    ...
    'docs/decisions/ADR-0034-model-mr-keywords-thought-links.md',
    'docs/decisions/ADR-0035-model-mr-comment-reading.md',
    'docs/decisions/ADR-0036-model-mr-doubao-processing.md',
    'docs/decisions/ADR-0037-beijing-collector-git-production-channel.md',
    'docs/decisions/ADR-0038-model-author-replies-and-blogger-parity.md',
    ...
    'docs/decisions/ADR-0043-model-mr-arrival-automatic-processing.md',
...
$requiredMemoryRules = @(
    ...
    @{ Path = 'STATUS.md'; Text = 'GRANDPAAMU_0_21_1_LIVE' },
