...
- 本地模型下载器 21 项回归通过；未发布代码在北京真实公开页的只读探针得到 20 条主页作品（17 视频、3 图文），准确命中目标 article，并识别 23 字标题、215 字正文、2 段及 1 张 176,249 字节 JPEG 封面。北京统一发布器再次通过服务器 21 项隔离测试和发布后真实扫描门禁；accepted/deployed/current 均为 `e91477c`，model/model-web/blogger 三服务 active，发布 timer 仍 disabled/inactive。
