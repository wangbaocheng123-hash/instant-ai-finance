...
- 当前阶段：`P2/P3 — 即时 AI 0.21.0 作者回复 MCP 与普通博主对齐正式生产；北京采集器 1.0.8 正式生产`
...
`手机使用验收`：在 ChatGPT 原有“即时 AI 资料智能体（云端）”连接中点击 Refresh，新建对话后让 GPT 先搜索模型先生作品，再调用 `get_model_mr_author_replies` 读取来源明确的本人回复及原提问。
