...
- 当前阶段：`P2/P3 — 即时 AI 0.21.1 博主自动处理修复与北京采集器 1.0.8 正式生产`
...
`手机真机验证 0.21.1`：刷新即时 AI 后，在“贵族之路”选一条开启前漏项点一次“一键补做”，或手动开启后用下一条新传视频观察自动入队，并核对页面依次显示视频原文、AI关键词和完成状态。
