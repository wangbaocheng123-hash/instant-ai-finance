...
- 本机正式端已发布并验证 `0.9.2`，阿里云端暂时仍为 `0.9.1`；本机 Python 服务监听 `127.0.0.1:18765`，桌面快捷方式和手机预览快捷方式均存在。
...
`P3-CLOUD-03`：把已验证的 0.9.2 通过统一 Git 与 Alibaba Cloud Client 增量发布到正式域名，并核验 iPhone Chrome 直达入口。
