...
| P3-CLOUD-03 | BLOCKED | 把 iPhone Chrome 直达修复统一发布到 GitHub 与阿里云 | 本机、GitHub main 与 `v0.9.2` 已同步；Alibaba Cloud Client 常规捕获与恢复重试均报 `0x80004002`，Computer Use 不允许自动操控远程终端；正式/应急域名仍健康返回 0.9.1，等待新的本次窄范围 SSH 授权或客户端兼容性恢复 |
