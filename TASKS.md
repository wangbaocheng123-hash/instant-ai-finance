...
| P3-AUTH-01 | IN_PROGRESS | 为云端增加单一主人登录和 30 天免重复登录 | ADR-0020；本机登录页、scrypt 哈希、签名 HttpOnly/SameSite/Secure Cookie、30 天到期、失败限流、缺配置锁定和登出已完成；30 项测试及 390×844 实测通过；待生产生成主人凭据并验收 HTTPS Cookie |
| P3-CLOUD-06 | IN_PROGRESS | 正式发布 0.13.0 模型先生精简模块与主人登录 | 用户已明确授权正式发布；本机 0.13.0 构建和 30 项测试通过；待 Git 推送、窄权限发布器快进、Git 外精简快照/主人凭据部署及正式域名验收 |
