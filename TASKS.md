...
| P2-WATCH-01 | DONE | 汇总罗盘首页/紫金时间线并建立即时 AI 重点事件监测列表 | ADR-0016；0.10.0 开发候选；罗盘窄范围只读接口返回 45 个节点（首页 14、紫金 31）；即时 AI schema 7 持久化同步与新闻匹配；手机版 AI 右侧新增“重点”；19 项测试、生产构建、零高危审计及桌面/手机预览通过，尚未正式发布 |
