...
from douyin_core import CDPConnection, CHROME_PATH, DownloadCancelled
...
class CommentCollector:
    ...
    def _optional_bool(raw: dict, *keys: str) -> bool | None:
        for key in keys:
            ...
            value = raw.get(key)
            if value is None:
                # Some payload variants keep an old alias as null while
                # providing the actual value under a newer alias.
                continue
